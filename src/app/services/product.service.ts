...
export class ProductService {
  ...
  private apiCreate = 'https://backend-optica-fmr.herokuapp.com/createproduct';  //Dirección y puerto donde está el servidor funcionando.
  private apiDelete = 'https://backend-optica-fmr.herokuapp.com/deleteproduct';  //Dirección y puerto donde está el servidor funcionando.
  private apiModify = 'https://backend-optica-fmr.herokuapp.com/modifyproduct';  //Dirección y puerto donde está el servidor funcionando.
  private apiUpload = 'https://backend-optica-fmr.herokuapp.com/uploadimage';  //Dirección y puerto donde está el servidor funcionando.
  private apiTypeProduct = 'https://backend-optica-fmr.herokuapp.com/typeproduct';  //Dirección y puerto donde está el servidor funcionando.
  private apiProducts = 'https://backend-optica-fmr.herokuapp.com/allproducts';  //Pedir todos los productos
