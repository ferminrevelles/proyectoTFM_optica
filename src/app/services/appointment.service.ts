...
export class AppointmentService {
  ...
  private apiReadAppointment = 'https://backend-optica-fmr.herokuapp.com/readappointment';  //Leer citas de la fecha indicada.
  private apiCreateAppointment = 'https://backend-optica-fmr.herokuapp.com/createappointment';  //Leer citas de la fecha indicada.
  private apiDeleteAppointment = 'https://backend-optica-fmr.herokuapp.com/deleteappointment';  //Borrar citas de la fecha indicada.
  private apiModifyAppointment = 'https://backend-optica-fmr.herokuapp.com/modifyappointment';  //Modificar citas de la fecha indicada.
  private apiReadAppointmentUser = 'https://backend-optica-fmr.herokuapp.com/readappointmentuser';  //Crear usuario con cita
  private apiCreateAppointmentUser = 'https://backend-optica-fmr.herokuapp.com/createappointmentuser';  //Crear usuario con cita
  private apiDeleteAppointmentUser = 'https://backend-optica-fmr.herokuapp.com/deleteappointmentuser';  //Crear usuario con cita
