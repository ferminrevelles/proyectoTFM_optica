...
export class OrdersService {
  ...
  private apiCreateOrder = 'https://backend-optica-fmr.herokuapp.com/createorder';  //Dirección y puerto donde está el servidor funcionando.
  private apiAllOrders = 'https://backend-optica-fmr.herokuapp.com/allorders';  //Dirección y puerto donde está el servidor funcionando.
  private apiReadOrder = 'https://backend-optica-fmr.herokuapp.com/readorder'; //Lee un pedido específico.
  private apiModifyOrder = 'https://backend-optica-fmr.herokuapp.com/modifyorder'; //modifica un pedido concreto
  private apiDeleteOrder = 'https://backend-optica-fmr.herokuapp.com/deleteorder'; //Borra un pedido.
  private apiOrderTemporalyUser = 'https://backend-optica-fmr.herokuapp.com/ordertemp'; //Llamada para guardar el pedido temporal del usuario.
