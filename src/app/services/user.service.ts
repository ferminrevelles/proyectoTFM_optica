...
export class UserService {
  ...
  private apiCreateUser = 'https://backend-optica-fmr.herokuapp.com/register';  //Crear usuario
  private apiDeleteUser = 'https://backend-optica-fmr.herokuapp.com/deleteuser';  //Borrar usuario
  private apiModifyUser = 'https://backend-optica-fmr.herokuapp.com/modifyuser';  //Borrar usuario
  ...
  private apiAllUsers = 'https://backend-optica-fmr.herokuapp.com/allusers';  //Dirección y puerto donde está el servidor funcionando.
